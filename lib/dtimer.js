...
function DTimer(id, pub, sub, option) {
    ...
    this._pub.defineCommand('update', {
        numberOfKeys: 5,
        lua: fs.readFileSync(__dirname + '/lua/update.lua', 'utf8')
    });

    this._pub.defineCommand('cancel', {
        numberOfKeys: 2,
        lua: fs.readFileSync(__dirname + '/lua/cancel.lua', 'utf8')
    });

    this._pub.defineCommand('changeDelay', {
        numberOfKeys: 1,
        lua: fs.readFileSync(__dirname + '/lua/changeDelay.lua', 'utf8')
    });
...
DTimer.prototype.join = function (cb) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        self._sub.subscribe(self._id, function (err) {
        ...
        return self._pub.multi()
            ...
            .update(
                ...
                debug(self._id+': new interval (2) ' + replies[2][1][1]);
...
DTimer.prototype._redisTime = function () {
    return Promise.resolve(this._pub.time().then(function (result) {
    ...
    return this._redisTime()
        ...
        .finally(function () {
            return new Promise(function (resolve) {
                self._sub.unsubscribe(self._id, function () {
                    resolve();
                });
            });
        })
